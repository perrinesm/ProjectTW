...
<html>
    ...
    <body style= "display: flex; flex-direction: column; margin-left: 19%">
        <div class="product" style="width: 76%">
            <h2> SurvivorPin 2.0 </h2>
            <p> <img style="width: 240px; height: 240px" src="tabS2.png" /> </p>
            <p style="padding-left: 15px; font-size: 120%"> Caractéristiques :<br />  </p>

            <p> <strong>Type de produit :</strong> Ordinateur militaire <br/>
