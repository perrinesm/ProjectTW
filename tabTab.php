...
<html>
    ...
    <body  style="display: flex; flex-direction: column;">
        ...
        <div class="product">  
            ...
            <p> <img class="pict" src="tabA1.png" /> </p>
        ...
        <div class="product">
            ...
            <p> <img class="pict" src="tabA2.png" /> </p>
            <p class="description"> Description </p>
        </div>

        <div class="product">
            <h4 >  <a href="tabS1.php"> Universe PinTab </a> </h4>
            <p> <img class="pict" src="tabS1.png" /> </p>
            <p class="description"> Description </p>
        </div>

        <div class="product">
            <h4>  <a href="tabS2.php"> PinTab Pro </a></h4>
            <p> <img class="pict" src="tabS2.png" /> </p>
            <p class="description"> Description </p>
        </div>
